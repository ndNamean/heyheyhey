...
const LEGACY_BIND = {
  ...
  defCanReview: "auth.ref('$user.profile.roleDefinition.canReview')[0] == true",
  defCanAccessAllStores: "auth.ref('$user.profile.roleDefinition.canAccessAllStores')[0] == true",
  defCanEditMaster: "auth.ref('$user.profile.roleDefinition.canEditMaster')[0] == true",
